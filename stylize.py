...
def stylize(network, initial, initial_noiseblend, content, styles, preserve_colors, colors, iterations,
            ...
            for i in range(iterations):
                ...
                if (checkpoint_iterations and i % checkpoint_iterations == 0) or last_step:
                    ...
                    if preserve_colors and preserve_colors == True:
                        ...
                        color_image = np.clip(colors, 0, 255)
                        ...
                        # 1
                        styled_grayscale = rgb2gray(color_image)
